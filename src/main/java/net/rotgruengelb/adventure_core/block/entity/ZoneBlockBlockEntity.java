...
public class ZoneBlockBlockEntity extends BlockEntity implements BlockEntityProvider {
	...
	public List<BlockZone> getZones() { return this.zones; }

	public void setZones(List<BlockZone> zones) { this.zones = zones; }

	public boolean shouldShowZones() { return this.showZones; }

	public void setShowZones(boolean b) { this.showZones = b; }
}
